...
(function(){
  ...
  function applyHandbookAdminUiFixes(){
    ...
    if(!document.getElementById(styleId)){
      ...
      style.id = styleId;
      style.textContent = ''
        + '.hb-admin-workspace{display:grid;grid-template-columns:minmax(360px,460px) minmax(0,1fr);gap:18px;align-items:start;}'
        ...
        + '#hbSimpleCatPreset{min-width:220px!important;width:100%!important;}'
        + '#hbSimpleCatTitle{min-width:220px!important;width:100%!important;}'
